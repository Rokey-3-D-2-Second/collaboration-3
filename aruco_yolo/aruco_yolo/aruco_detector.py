...
class ArucoMarkerDetector(Node):
    def __init__(self):
        ...
        self.detected_marker_publisher_ = self.create_publisher(CompressedImage, 'detected_marker/compressed', 10)
...
#######################################################################      
        ...
        # cv2.waitKey(1)
        self.detected_marker_publisher_.publish(self.bridge.cv2_to_compressed_imgmsg(frame))
